...
/**
 * The alignment of the {@link IWidget} defines the position of the element relative to the position of its parent.
 */
public enum WidgetAlignment {
	...
	WidgetAlignment(float xOffset, float yOffset) {
