...
import leviathan.utils.I18N;
import leviathan.utils.Sprite;

public class TankElement extends Widget {
	/* Attributes - Final */
	@Nullable
	...
	public TankElement(int xPos, int yPos, @Nullable Sprite background, Supplier<FluidTankInfo> tank) {
		this(xPos, yPos, background, tank, null);
	}

	public TankElement(int xPos, int yPos, @Nullable Sprite background, Supplier<FluidTankInfo> tank, @Nullable Sprite overlay) {
		this(xPos, yPos, background, tank, overlay, 16, 58);
	}

	public TankElement(int xPos, int yPos, @Nullable Sprite background, Supplier<FluidTankInfo> tank, @Nullable Sprite overlay, int width, int height) {
	...
	public List<String> getTooltip(int mouseX, int mouseY) {
		...
		String liquidAmount = I18N.localise("for.gui.tooltip.liquid.amount", amount, tankInfo.capacity);
